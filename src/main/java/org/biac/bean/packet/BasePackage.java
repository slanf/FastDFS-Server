package org.biac.bean.packet;

import org.biac.exception.CrcCheckErrorException;
import org.biac.exception.DataFormatException;
import org.biac.exception.IllegalPackageException;
import org.biac.service.*;
import org.biac.tool.ByteArrayTool;
import org.biac.tool.CrcTool;
...
public class BasePackage {
    ...
    public void check() throws IllegalPackageException,CrcCheckErrorException,DataFormatException {
        if (!(originalData[0]=='B' && originalData[1]=='I')){
